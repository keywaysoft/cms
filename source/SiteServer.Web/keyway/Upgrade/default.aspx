...
<div class="wrap">
  <DIV class="top">
    ...
    <DIV class="top-link">
      <UL>
         <LI>
                        <A href="http://www.keywaysoft.com/" target="_blank">官方网站</A> </LI>
                      <LI>
                        <A href="http://bbs.keywaysoft.com/" target="_blank">技术论坛</A> </LI>
                      <LI>
                        <A href="http://cms.keywaysoft.com/" target="_blank">系统帮助</A> </LI>
      </UL>
    </DIV>
        ...
        <div class="form_detail">
          <div class="error">
            ...
            <p class="success" style="background-repeat:no-repeat; padding:15px; padding-left:50px;margin-right:100px;">
              <span style="position:absolute; margin-top:0px;">恭喜，您已经完成了 Keyway WCM<span style="font-size:6px; position:relative; top:-10px">TM</span>&nbsp;&nbsp;系列产品的升级，<A href='<%=GetSiteServerUrl()%>'>进入后台</A>。</span>
            </p>
          </asp:PlaceHolder>
        </div>
      </form>
