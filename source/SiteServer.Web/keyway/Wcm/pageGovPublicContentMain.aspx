...
<frameset id="frame" framespacing="0" border="false" cols="180,*" frameborder="0" scrolling="yes">
	<frame name="tree" scrolling="auto" style="border-right: 1px solid #f4f4f4"  marginwidth="0" marginheight="0" src="pageGovPublicContentTree.aspx?PublishmentSystemID=<%=PublishmentSystemId%>&RightPageURL=pageGovPublicContent.aspx" >
