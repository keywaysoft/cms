...
<body class="yunBg">
    <form class="form-inline" runat="server" autocomplete="off">
        <div class="yunMain">
            <div class="yunTop">
                <a class="yunLogo" href="http://www.anzhou.gov.cn"><img src="pic/login/anzhou.png" /></a>
            </div>
            <div class="yunItmName">
                <img src="pic/login/yun_ico1.jpg" width="31" height="32" /><span class="yunItmS">网站集约化平台管理系统</span>
            </div>
            <div class="yunBox">
                ...
                <div class="yun_u1">
                    <ul>
                        ...
                        <li><span class="yun_s1">&nbsp;</span>
                            <asp:Button class="yun_submit" Text="登 录" ID="LoginSubmit" Style="width: 101px" OnClick="Submit_OnClick" runat="server" />
                            &nbsp;
            ...
            <div class="yunFooter">安州区信息化工作办公室建设维护  技术保障电话 0816-4509769 2468030 Copyright © 2008-<script>document.write(new Date().getFullYear());</script></div>
        </div>
    </form>
</body>
</html>
