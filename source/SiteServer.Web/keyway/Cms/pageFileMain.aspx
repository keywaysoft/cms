...
<frameset id="frame" framespacing="0" border="false" cols="180,*" frameborder="0" scrolling="yes">
	<frame name="tree" style="border-right: 1px solid #f4f4f4"  scrolling="auto" marginwidth="0" marginheight="0" src="pageFileTree.aspx?PublishmentSystemID=<%=PublishmentSystemId%>&RightPageURL=pageFilemanagement.aspx" >
