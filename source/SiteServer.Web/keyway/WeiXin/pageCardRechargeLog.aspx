<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.WeiXin.PageCardRechargeLog" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
            <table class="table table-noborder">
                <tr>
                    <td>  
                         会员卡：<asp:DropDownList ID="DdlCard" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick"></asp:DropDownList>&nbsp;&nbsp;
