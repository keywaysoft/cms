<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.WeiXin.PageYaoYaoAdd" %>
...
<form class="form-inline" runat="server">
  ...
  <script type="text/javascript" src="background_yaoYaoAdd.js"></script>
  <style type="text/css">
  div.step {
  font-weight: bold;
  font-size: 16px;
    ...
    <div class="popover-content">
      ...
      <asp:PlaceHolder id="PhStep1" runat="server">
        <div class="row-fluid">
          ...
          <div class="Span6">
            <div class="step">第一步：配置摇摇乐开始属性</div>
            <table class="table noborder table-hover">
              ...
              <tr>
                <td>摇摇乐状态：</td>
                <td class="checkbox">
                  <asp:CheckBox id="CbIsEnabled" runat="server" checked="true" text="启用摇摇乐" />
                </td>
              </tr>
              <tr>
                <td>触发关键词：</td>
      ...
      <asp:PlaceHolder id="PhStep2" visible="false" runat="server">
        <div class="row-fluid">
          ...
          <div class="Span6">
            <div class="step">第二步：配置摇摇乐详情页</div>
            <table class="table noborder table-hover">
              <tr>
                <td width="120">摇摇乐活动规则：</td>
                <td>
...
3.本活动组织方拥有最终解释权" />
      ...
      <asp:PlaceHolder id="PhStep5" visible="false" runat="server">
        <div class="row-fluid">
          ...
          <div class="Span6">
            <div class="step">第五步：配置摇摇乐结束属性</div>
            <table class="table noborder table-hover">
              <tr>
                <td width="120">摇摇乐结束主题：</td>
                <td>
