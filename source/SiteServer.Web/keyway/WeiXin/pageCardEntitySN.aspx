<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.WeiXin.PageCardEntitySN" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="well well-small">
            ...
            <div class="btn-toolbar" role="toolbar">
                <div class="btn-group">
                     <asp:Button id="wxCard" runat="server" CssClass="btn btn-default"  Width="200"  OnClick="Search_OnClick" Text="微信会员"/>
                     <asp:Button id="entityCard" runat="server" CssClass="btn btn-default active" Width="200" OnClick="Search_OnClick"  Text="实体卡会员"/> 
                     <input type ="hidden" runat="server" id="isEntity" value="true" />
                     </div>
            </div>
        </div>
            ...
            <asp:Repeater ID="RptContents" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="center">
                            <asp:Literal ID="LtlIsBinding" runat="server"></asp:Literal>
                        </td>
                        <td class="center">
