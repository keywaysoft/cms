<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.WeiXin.PageMapAdd" %>
    ...
    <div class="popover-content">
      ...
      <asp:PlaceHolder id="PhStep1" runat="server">
        <div class="row-fluid">
          ...
          <div class="Span6">
            <div class="step">第一步：配置微导航开始属性</div>
            <table class="table noborder table-hover">
              ...
              <tr>
                <td>微导航状态：</td>
                <td class="checkbox">
                  <asp:CheckBox id="CbIsEnabled" runat="server" checked="true" text="启用微导航" />
                </td>
              </tr>
              <tr>
                <td>触发关键词：</td>
      ...
      <asp:PlaceHolder id="PhStep2" visible="false" runat="server">
        <div class="row-fluid">
          ...
          <div class="step">第二步：配置微导航地址</div>

           <table class="table noborder table-hover">
              <tr>
                <td width="120">详细地址：</td>
                <td>
                  <asp:TextBox class="input-xlarge" id="TbMapWD" runat="server"/>
                  <asp:RequiredFieldValidator
                    ControlToValidate="TbMapWD"
                    errorMessage=" *" foreColor="red" 
                    Display="Dynamic"
                    runat="server"/>
                  <asp:RegularExpressionValidator
                    ...
                    Display="Dynamic" />
                    &nbsp;
                    <asp:Button class="btn btn-success" text="查看位置" OnClick="Preview_OnClick" runat="server"/>
                </td>
              </tr>
            </table>

            <div style="height:300px"><asp:Literal id="LtlMap" runat="server" /></div>
