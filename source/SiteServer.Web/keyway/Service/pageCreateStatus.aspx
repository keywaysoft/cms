            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="alert alert-danger fade in m-b-0">
                  <h4>Scheduler.exe 服务组件未启动</h4>
                  <p>
                    Scheduler.exe 服务组件未启动，请在Keyway WCM系统根目录下双击运行Scheduler.exe程序启用服务。
                  </p>
                </div>
              </div>
              ...
              <div class="card-box">
                  ...
                  <asp:PlaceHolder id="PhRunService" runat="server">
                    <div class="alert alert-warning fade in m-b-0">
                      <h4>为提高生成页面速度，建议启动Scheduler.exe 服务组件生成页面</h4>
                      <p>
                        请在Keyway WCM系统根目录下双击运行Scheduler.exe程序启用服务。
                      </p>
                    </div>
                  </asp:PlaceHolder>
